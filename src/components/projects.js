...
import seakam from '../portfolio/Screenshot 2024-05-08 103933.png'
import "animate.css/animate.min.css";
function Projects({screenPos}) {

  return (
    <div className='projectCover'>
      <div className='projectShade' style={{opacity: `${1800/screenPos}`}}>
          ...
          <div className='project'>
            <div className='projectSet'>
              <div className='projectItem'>
                <img src={seakam} alt="Seakam" />
              </div>
              <div className='projectDescription'>
                <p> Seakam Global Resources Limited is a local company in Nigeria specialized in manufacturing various herbal drinks that can also be taken socially. The Company has to its credit various products sold across Nigeria and currently working on expotation to various African Countries and other Continents. The company had produced various herbal drinks such as Seakam Bitters, Doro Bitters and Bajinotu alcoholic drinks which are used in treating various stomach related ailment as a result of the herbs carefully blended to meet the current demands of the people consuming different kinds of food that are harmful to the body.</p>
              </div>
            </div>
            <h3>Seakam</h3>
            <div className='projectLink'>
              <a href="https://seakam-omega.vercel.app/" target='blank'>Live</a>
            </div>
          </div>
        </AnimationOnScroll>
        <AnimationOnScroll animateIn='animate__flipInY'>
